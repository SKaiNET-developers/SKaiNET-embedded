...
dependencies {
    implementation("sk.ainet.core:skainet-lang-core:0.29.0")
    implementation("sk.ainet.core:skainet-compile-hlo:0.29.0")
    implementation("sk.ainet.core:skainet-io-image:0.29.0")
}
----
